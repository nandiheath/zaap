...
# Create directories
SRC_DIR="manifests/infrastructure/${APP_NAME}"
RENDERED_DIR="artifacts/infrastructure/${APP_NAME}"
...
cat > "manifests/infrastructure/argocd-app-of-apps/apps/${APP_NAME}.yaml" << EOF
...
spec:
  source:
    path: artifacts/infrastructure/${APP_NAME}
  destination:
    namespace: ${NAMESPACE}
EOF
...
KUSTOMIZATION_FILE="manifests/infrastructure/argocd-app-of-apps/kustomization.yaml"
...
echo "Application definition: manifests/infrastructure/${APP_NAME}.yaml"
